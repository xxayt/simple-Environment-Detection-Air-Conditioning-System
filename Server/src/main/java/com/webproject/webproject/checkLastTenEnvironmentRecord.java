...
@WebServlet(name = "CheckLastTenEnvironmentRecord", value = "/checkLastTenEnvironmentRecord")
public class checkLastTenEnvironmentRecord extends HttpServlet {
    @Override
    ...
    public void doCheckEnvironmentRecord(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
        ...
        String sql="select * from environment order by recordId desc limit 10 ;";
        try{
